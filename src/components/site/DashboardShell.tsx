            ...
            <div className="border-t border-border p-4">
              {isStaffPanel && (
                <button
                  ...
                  className="mb-3 flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-background px-3 py-2.5 text-sm font-medium transition hover:bg-muted"
                >
              ...
              <div className="flex min-w-0 items-center gap-2 sm:gap-3">
                {isStaffPanel && (
                  <button
                    ...
                    className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-border bg-background px-3 py-2 text-xs font-semibold transition hover:bg-muted sm:text-sm"
                  >
