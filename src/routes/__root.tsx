...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  const message =
    error?.message && !/missing supabase/i.test(error.message)
      ? error.message
  ...
  head: () => ({
    meta: [
      ...
      { title: "Asá — Trusted. Verified. Nearby." },
      {
        name: "description",
        content:
          "Nigeria's premium marketplace for verified skilled professionals. Book electricians, tailors, cleaners, mechanics and more.",
      },
      { name: "author", content: "Asá" },
      { property: "og:title", content: "Asá — Trusted. Verified. Nearby." },
      {
        property: "og:description",
        content: "Nigeria's premium marketplace for verified skilled professionals.",
      },
